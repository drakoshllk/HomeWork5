    ...
    */
    ...
    public static class Person {
        ...
        void takeDamage (int damage) throws PersonDead, Exception {
            ...
            if ((this.health - (damage - this.protection)) <= 0) {
                this.health = 0;
                throw new PersonDead("");
            } else this.health = this.health - (damage - this.protection);
        }
    ...
    public static class Mage extends Person {
        ...
        Person person = new Person(getName(), this.health, this.protection);
        ...
        void takeDamage (int damage) throws PersonDead, Exception {
            if (damage < 0) throw new Exception();
            if ((this.health - (damage - this.protection - this.health % 10)) <= 0) {
                this.health = 0;
                throw new PersonDead("");
            } else this.health = this.health - (damage - this.protection - this.health % 10);
        }
